...
void TIMER_EnableCapture(TIMER_T *timer, uint32_t u32CapMode, uint32_t u32Edge)
{
    ...
    timer->EXTCTL = (timer->EXTCTL & ~((0x1ul << (4)) |
                                       (0x3ul << (1)))) |
...
uint32_t TIMER_GetModuleClock(TIMER_T *timer)
{
    ...
    if(timer == ((TIMER_T *) ((((uint32_t)0x40000000) + 0x00040000) + 0x10000)))
        u32Src = (((CLK_T *) (((uint32_t)0x40000000) + 0x00200))->CLKSEL1 & (0x7ul << (8))) >> (8);
    else if(timer == ((TIMER_T *) ((((uint32_t)0x40000000) + 0x00040000) + 0x10020)))
        u32Src = (((CLK_T *) (((uint32_t)0x40000000) + 0x00200))->CLKSEL1 & (0x7ul << (12))) >> (12);
    else if(timer == ((TIMER_T *) ((((uint32_t)0x40000000) + 0x00040000) + 0x11000)))
