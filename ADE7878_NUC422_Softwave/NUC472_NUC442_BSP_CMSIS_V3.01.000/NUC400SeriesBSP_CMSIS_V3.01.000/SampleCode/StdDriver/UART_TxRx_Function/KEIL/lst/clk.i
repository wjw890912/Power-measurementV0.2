...
void CLK_DisableCKO(void)
{
    ...
    ((CLK_T *) (((uint32_t)0x40000000) + 0x00200))->APBCLK0 &= (~(6));
}
...
void CLK_EnableCKO(uint32_t u32ClkSrc, uint32_t u32ClkDiv, uint32_t u32ClkDivBy1En)
{
    ...
    ((CLK_T *) (((uint32_t)0x40000000) + 0x00200))->CLKSEL1 = (((CLK_T *) (((uint32_t)0x40000000) + 0x00200))->CLKSEL1 & (~(0x3ul << (28)))) | u32ClkSrc;
}
...
void CLK_PowerDown(void)
{
    ...
    ((CLK_T *) (((uint32_t)0x40000000) + 0x00200))->PWRCTL |= ((0x1ul << (7)) | (0x1ul << (4)) );
    __wfi();
}
...
uint32_t CLK_GetPCLKFreq(void)
{
    ...
    if(((CLK_T *) (((uint32_t)0x40000000) + 0x00200))->CLKSEL0 & (0x1ul << (6)))
...
uint32_t CLK_GetPLLClockFreq(void)
{
    ...
    u32PllReg = ((CLK_T *) (((uint32_t)0x40000000) + 0x00200))->PLLCTL;

    if((u32PllReg & (0x1ul << (20))))
        return 0;
...
uint32_t CLK_SetCoreClock(uint32_t u32Hclk)
{
    ...
    ((CLK_T *) (((uint32_t)0x40000000) + 0x00200))->PLLCTL = u32Register | ((u32NR - 2)<<9) | (u32NF - 2) ;
...
void CLK_SetModuleClock(uint32_t u32ModuleIdx, uint32_t u32ClkSrc, uint32_t u32ClkDiv)
{
    ...
    if(((u32ModuleIdx >>10) & 0xff)!=0x0) {
        u32div =(uint32_t)&((CLK_T *) (((uint32_t)0x40000000) + 0x00200))->CLKDIV0+((((u32ModuleIdx >>18) & 0x3))*4);
    ...
    if(((u32ModuleIdx >>25) & 0x7)!=0x0) {
        u32sel = (uint32_t)&((CLK_T *) (((uint32_t)0x40000000) + 0x00200))->CLKSEL0+((((u32ModuleIdx >>28) & 0x3))*4);
...
void CLK_EnableModuleClock(uint32_t u32ModuleIdx)
{
    *(volatile uint32_t *)((uint32_t)&((CLK_T *) (((uint32_t)0x40000000) + 0x00200))->AHBCLK+(((u32ModuleIdx >>30) & 0x3)*4))  |= 1<<((u32ModuleIdx >>0 ) & 0x1f);
}
...
uint32_t CLK_EnablePLL(uint32_t u32PllClkSrc, uint32_t u32PllFreq)
{
    ...
    if(u32PllClkSrc==(0x1UL<<(19))) {
        ((CLK_T *) (((uint32_t)0x40000000) + 0x00200))->PLLCTL = (((CLK_T *) (((uint32_t)0x40000000) + 0x00200))->PLLCTL & ~(0x1ul << (16))) | ((0x1UL<<(19)));
        u32Register = 1<<(19);
        u32ClkSrc = (22118400UL);
    } else {
        ((CLK_T *) (((uint32_t)0x40000000) + 0x00200))->PLLCTL = (((CLK_T *) (((uint32_t)0x40000000) + 0x00200))->PLLCTL & ~(0x1ul << (16)));
        u32Register = 0<<(19);
        u32ClkSrc = (12000000UL);
    }

    if(u32PllFreq<50000000) {
        u32PllFreq <<=2;
        u32Register |= (0x3<<(14));
    } else {
        u32PllFreq <<=1;
