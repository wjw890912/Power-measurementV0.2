...
void UART_Open(UART_T* uart, uint32_t u32baudrate)
{
    ...
    u8UartClkSrcSel = (((CLK_T *) (((uint32_t)0x40000000) + 0x00200))->CLKSEL1 & (0x3ul << (24))) >> (24);

    uart->FUNCSEL = (0x0 << (0));
    uart->LINE = (3) | (0x0 << (3)) | (0x0 << (2));
    uart->FIFO = (0x0 << (4)) | (0x0 << (16));

    u32Clk = (u32ClkTbl[u8UartClkSrcSel]) / (((((CLK_T *) (((uint32_t)0x40000000) + 0x00200))->CLKDIV0 & (0xful << (8))) >> (8)) + 1);
