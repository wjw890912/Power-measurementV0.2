...
{
    return (((SYS_T *) (((uint32_t)0x40000000) + 0x00000))->BODCTL & (0x1ul << (6)));
}
...
uint32_t SYS_IsRegLocked(void)
{
    return (((SYS_T *) (((uint32_t)0x40000000) + 0x00000))->REGLCTL & (0x1ul << (0)));
}
...
void SYS_UnlockReg(void)
{
    while(((SYS_T *) (((uint32_t)0x40000000) + 0x00000))->REGLCTL != (0x1ul << (0))) {
...
void SYS_EnableBOD(int32_t i32Mode, uint32_t u32BODLevel)
{
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000))->BODCTL &= ~((0x3ul << (1))|(0x1ul << (3)));
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000))->BODCTL |=(i32Mode|u32BODLevel|(0x1ul << (0)));
}
