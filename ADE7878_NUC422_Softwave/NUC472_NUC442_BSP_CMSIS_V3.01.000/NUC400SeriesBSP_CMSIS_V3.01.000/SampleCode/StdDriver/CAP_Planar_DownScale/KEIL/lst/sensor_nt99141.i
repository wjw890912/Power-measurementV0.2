...
int InitNT99141_VGA_YUV422(void)
{
    ...
    uint8_t u8ID[2]= {0};
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000))->GPB_MFPL &= ~(0xful << (24));         
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000))->GPB_MFPL &= ~(0xful << (28));         
    ...
    u8ID[0]=SWI2C_Read_8bitSlaveAddr_16bitReg_8bitData(u8DeviceID,0x3000);   
    u8ID[1]=SWI2C_Read_8bitSlaveAddr_16bitReg_8bitData(u8DeviceID,0x3001);   
