...
/**
  ...
  * @param    disk      The disk pointer.
  * @param    sectorN   The logical sector number to be read.
  * @param    scnt      Number of continuous sectors to be read.
...
/**
  ...
  * @param    disk      The disk pointer.
  * @param    sectorN   The logical sector number to be written.
  * @param    scnt      Number of continuous sectors to be written.
  * @param    buff      Data buffer.
  * @retval   0    Success
  * @retval   -1   Failed
  */
