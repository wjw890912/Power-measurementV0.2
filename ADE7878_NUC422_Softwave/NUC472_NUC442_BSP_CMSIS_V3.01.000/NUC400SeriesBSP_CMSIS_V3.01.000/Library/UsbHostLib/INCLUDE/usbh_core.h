...
typedef struct usb_endpoint_descriptor  /*!< Endpoint descriptor structure          */
{
    ...
    __packed uint8_t  bInterval;        /*!< Synchrinous transfer interval          */
...
typedef struct usb_device               /*!< USB device structure                   */
{
    ...
    signed char act_config;             /*!< Active configuratio number             */
...
/** @addtogroup NUC472_442_USBH_CORE_Driver USB Host Core Driver
  @{
*/


/** @addtogroup NUC472_442_USBH_CORE_EXPORTED_FUNCTIONS USB Host Core Driver Exported Functions
  @{
*/

extern int32_t  USBH_Open(void);
extern void     USBH_ProcessHubEvents(void);
...
/*@}*/ /* end of group NUC472_442_USBH_CORE_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NUC472_442_USBH_CORE_Driver */
...
extern struct ohci_td_t * ohci_alloc_td(void);
