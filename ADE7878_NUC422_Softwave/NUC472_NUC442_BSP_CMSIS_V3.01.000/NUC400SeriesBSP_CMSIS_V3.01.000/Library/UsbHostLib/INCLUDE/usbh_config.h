...
#define URB_MAX_NUM				16      /*!< Maximum number of URBs in memory pool      */
#define ED_MAX_NUM				16      /*!< Maximum number of OHCI EDs in memory pool  */
#define TD_MAX_NUM				64      /*!< Maximum number of OHCI TDs in memory pool  */
...
#define OHCI_ISO_DELAY			0       /*!< Delay isochronous transfer frame time      */
...
#define USB_JIFFY            	(OHCI->HcFNum & 0xffff)
